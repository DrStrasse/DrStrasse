...
check("терминал v1.1.0", has(svT, 'T.Version = "1.1.0 — OS 2.0 photorobot attach"'), T.Version)
check("legacy-канал тоже требует близкий терминал", has(svT, "validTerminal(ply, jur)"))
