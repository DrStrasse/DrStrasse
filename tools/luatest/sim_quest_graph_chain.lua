...
do
    ...
    -- Оба меню перешли на общий модуль.
    ok(inter:find("GRM.Radial", 1, true) ~= nil, "меню взаимодействия использует модуль")
    ok(anims:find("GRM.Radial", 1, true) ~= nil, "меню анимаций тоже")
