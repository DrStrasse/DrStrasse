...
local function bin(x,name)local b={_valid=true,_pos=Vector(x,0,0),nw={},ready=0,name=name};function b:GetPos()return self._pos end;function b:SetNWString(k,v)self.nw[k]=v end;function b:GetNWString(k,d)local v=self.nw[k];if v==nil then return d end;return v end;function b:GetReadyAt()return self.ready end;function b:EntIndex()return x end;return b end
...
local routes=JB.GetRoutePoints("garbage")or{}
