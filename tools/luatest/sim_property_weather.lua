...
ok(weather:find("rain_loop.wav",1,true)and weather:find("storm_loop.wav",1,true)and weather:find("CreateSound",1,true)and weather:find("ChangeVolume",1,true),"rain and storm use Source sound patches")
ok(rainSize>700000 and stormSize>700000 and weather:find('W.Version="1.2.0"',1,true),"detailed 24-second water/drop layers replace television noise")
