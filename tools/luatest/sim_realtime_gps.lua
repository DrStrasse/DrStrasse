...
ok(time:find("GRM_RealTime_Sync",1,true)and time:find("grm_time_utc_offset_minutes",1,true),"server-authoritative real-time sync")
ok(time:find("/time",1,true)and time:find("PlayerSayTransform",1,true),"time command supports chat and EasyChat")
ok(tab:find("clockPanel",1,true)and tab:find("GRM_RealTime",1,true),"TAB header contains live clock panel")
