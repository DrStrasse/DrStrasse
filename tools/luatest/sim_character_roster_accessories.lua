...
ok(npc:find("SelectWeightedSequence",1,true)~=nil and npc:find("FrameAdvance",1,true)~=nil,"duty NPC has animated idle instead of T-pose")
...
print(("CHAR/ROSTER/ACCESSORIES: 12 checks, failures=%d"):format(fail));os.exit(fail==0 and 0 or 1)
