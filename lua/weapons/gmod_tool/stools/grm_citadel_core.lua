TOOL.Category="GRM"
TOOL.Name="Ядро Цитадели"
TOOL.Command=nil
TOOL.ConfigName=""
TOOL.ClientConVar={type="core"}
if CLIENT then language.Add("tool.grm_citadel_core.name","Ядро Цитадели"); language.Add("tool.grm_citadel_core.desc","Установка ядра тёмной материи и терминала управления"); language.Add("tool.grm_citadel_core.0","ЛКМ: установить. ПКМ: удалить. R: отмена") end
