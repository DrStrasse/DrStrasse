...
if SERVER then
    ...
    local PERM_CLASSES = {
        ...
        grm_augmentation_station = true,
        grm_citadel_core = true,
        grm_citadel_core_terminal = true,
        grm_augmentation_pod = true,
        grm_augmentation_chip = true,
    ...
    GRM.PermData.Extract["grm_citadel_core"] = function(ent) return IsValid(ent) and ent.GetPermData and ent:GetPermData() or nil end
    GRM.PermData.Apply["grm_citadel_core"] = function(ent,data) if IsValid(ent) and ent.ApplyPermData then ent:ApplyPermData(data) end end
