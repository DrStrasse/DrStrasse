...
local CMD_GROUPS = {
    ...
    { name = "Телефон", items = {
        ...
        { "СТРЕЛКА ВВЕРХ", "Открыть мобильный (телефон в инвентаре). ↑↓ — навигация, ENTER — открыть/ответить, BACKSPACE — назад/трубка, цифры — набор. Запасной путь: консоль grm_mobile_open" },
