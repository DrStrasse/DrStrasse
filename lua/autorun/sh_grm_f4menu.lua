...
local CMD_GROUPS = {
    ...
    { name = "Пропы и стройка", items = {
        ...
        { "Настройки", "grm_prop_ghost, grm_prop_ghost_alpha, grm_prop_spam_count, grm_prop_spam_window, grm_prop_spam_block, grm_prop_spam_admins, grm_prop_zone_guard, grm_prop_zone_margin" },
    }},
