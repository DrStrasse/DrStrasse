...
GRM.F4 = GRM.F4 or {}
local F4 = GRM.F4
F4.Version = "1.4.3" -- +дилер 2.0 (оплата/возврат), C-меню Т/С, вкладки Экономика/Инструменты (Коды 82/83)
...
local CMD_GROUPS = {
    ...
    { name = "Транспорт", items = {
        ...
        { "C по машине (зажать)", "Контекст Т/С: замок, багажник, убрать своё Т/С (возврат 50%). Админ — убрать любое дилерское" },
        { "Дилер (E)", "Покупка за наличные по цене из меню; служебный транспорт фракции — бесплатно; секция «МОЙ ТРАНСПОРТ» с кнопкой УБРАТЬ (возврат 50%)" },
        ...
        { "/logistics_start", "Логистика: начать рейс (водителем разрешённой матовозки, по доступу)" },
    ...
    { name = "Радио и оповещение", items = {
        { "E по микрофону", "Пульт эфира: позывной, старт/стоп (СМИ)" },
        { "E по приёмнику", "Настроить радио на станцию / выключить" },
        { "/alert текст", "Оповещение района (слышно у громкоговорителей)" },
    ...
    { name = "Админ-панели (суперадмин)", items = {
        ...
        { "/grm_admin → «Инструменты»", "Q-меню игрокам вкл/выкл, спавн (пропы/NPC/SENT/SWEP/транспорт), чёрный список toolgun-инструментов или строгий белый режим; конфиг сохраняется" },
        { "/feco_admin", "Экономика: фракции, ЗП и налоги, гос.бюджет, балансы налички/банка, общие настройки (= /salary_admin, консоль grm_salary_admin)" },
        { "!econadmin, !grmmenu", "Касса админа: выдача/снятие игрокам и фракциям, персональные налоги, переводы" },
        { "/factions", "Фракции: руководство/состав/доступы/расширенные настройки" },
