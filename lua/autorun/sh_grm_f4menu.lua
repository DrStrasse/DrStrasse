...
GRM.F4 = GRM.F4 or {}
local F4 = GRM.F4
F4.Version = "1.4.2" -- +денежный дроп/упаковка, розыск-ордера, логистика, группа «Админ-панели» (Код 81)
...
local CMD_GROUPS = {
    ...
    { name = "Админ-панели (суперадмин)", items = {
        { "/grm_admin", "ЕДИНАЯ панель: сервер/доступы/биржа/игроки + ярлыки всех меню ниже" },
