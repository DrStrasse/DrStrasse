...
GRM.F4 = GRM.F4 or {}
local F4 = GRM.F4
F4.Version = "1.4.5" -- +Root Guard (код 84), доска: автозачисление отдел/должность, Q-гейт универсальный
...
local CMD_GROUPS = {
    ...
    { name = "Админ-панели (суперадмин)", items = {
        ...
        { "/grm_admin → «Инструменты»", "Q-меню игрокам вкл/выкл (гасит и ванильное, и кастомное Q по бинду), спавн (пропы/NPC/SENT/SWEP/транспорт), чёрный список toolgun-инструментов или строгий белый режим; конфиг сохраняется" },
