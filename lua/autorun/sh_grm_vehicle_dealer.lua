  ...
  elseif op=="fleet_buy"then
   ...
   if marketID~="" then
    ...
    if exact and tostring(exact.class)==class then
     ...
     result(ply,false,"Цена позиции изменилась — обновите окно дилера и повторите закупку")
     return
    end
   end
   if not pick then
