...
local BTNS = {
    ...
    { id = "soc_hands", l = "Аним: руки вверх", fn = function() RunConsoleCommand("grm_social", "hands") end,
      c = Color(80, 125, 185), ch = Color(100, 150, 210), ok = function() return true end },
    { id = "soc_kneel", l = "Аним: на коленях", fn = function() RunConsoleCommand("grm_social", "kneel") end,
      c = Color(80, 125, 185), ch = Color(100, 150, 210), ok = function() return true end },
    { id = "soc_docs",  l = "Аним: документы", fn = function() RunConsoleCommand("grm_social", "docs") end,
      c = Color(80, 125, 185), ch = Color(100, 150, 210), ok = function() return true end },
    { id = "soc_stop",  l = "Снять позу", fn = function() RunConsoleCommand("grm_social_stop") end,
      c = Color(90, 90, 110), ch = Color(110, 110, 130), ok = function() return true end },
