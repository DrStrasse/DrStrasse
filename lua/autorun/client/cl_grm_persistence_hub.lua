...
local rows = {
    ...
    { id = "factory", name = "Завод", desc = "Станки, склады, шкафы, запасы скупщиков и цены рынка." },
    { id = "logistics", name = "Логистика", desc = "Точки, склады, шкафы, доступ, транспорт и переносимые ящики." },
    { id = "food", name = "Еда и кухня", desc = "Автоматы, плиты, холодильники, горшки и их текущее содержимое." },
    { id = "roomtap", name = "RoomTap", desc = "Постоянные/временные устройства прослушки и матрица доступа." },
    { id = "wanted", name = "Розыск", desc = "База розыска и связанные данные." },
    { id = "mining", name = "Шахта", desc = "Скупщики, ручные узлы и отдельные точки автореспавна руды." },
