...
local rows = {
    ...
    { id = "electronics", name = "Электроника и сеть", desc = "Компьютеры, роутеры, принтеры, розетки, кабели и база сети (аккаунты/файлы/почта)." },
    { id = "vehicle_dealers", name = "Дилеры и гаражи", desc = "NPC дилеров, площадки выдачи, ассортимент и гаражи персонажей." },
}
