...
if SERVER then
 ...
 local function public(r,sensitive)return{id=r.id,name=r.name,type=r.type,typeName=P.Types[r.type],doors=#r.doors,ownerType=r.ownerType,ownerKey=sensitive and r.ownerKey or"",ownerName=r.ownerName,tenure=r.tenure,rentUntil=r.rentUntil,purchasePrice=r.purchasePrice,rentPrice=r.rentPrice,utilityRate=r.utilityRate,utilityDebt=r.utilityDebt,sealed=r.sealed,sealReason=r.sealReason,sealUntil=r.sealUntil,alarmNetwork=sensitive and r.alarmNetwork or"",cameraIDs=sensitive and r.cameraIDs or{},employees=sensitive and r.employees or{},guests=sensitive and r.guests or{},tempKeys=sensitive and r.tempKeys or{},zone=r.zone}end
