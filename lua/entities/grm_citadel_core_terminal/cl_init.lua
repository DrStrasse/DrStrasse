...
function ENT:Draw()
 self:DrawModel(); local p=self:GetPos()+self:GetUp()*28; local a=LocalPlayer():EyeAngles(); a:RotateAroundAxis(a:Forward(),90); a:RotateAroundAxis(a:Right(),90); cam.Start3D2D(p,a,.08); draw.RoundedBox(5,-150,-30,300,60,Color(5,15,25,220)); draw.SimpleText("ТЕРМИНАЛ ЯДРА","DermaLarge",0,-15,Color(80,210,255),TEXT_ALIGN_CENTER); draw.SimpleText("E — управление","DermaDefault",0,14,Color(220,230,240),TEXT_ALIGN_CENTER); cam.End3D2D()
end
