...
**Текущая точка:** Код 62 Persistence Guard; Build Tools 61, QMenu 4.2.0, Fire 1.5.1, Documents 2.1.0, Perm 1.7.1, Persistence Hub 1.1, Sliding 1.1.0, FFD Link 1.2.0, Prop Protect 2.1.0.
**Репо:** `https://github.com/DrStrasse/DrStrasse`
**Следующий свободный номер модуля:** **Код 63**.

Сначала читать актуальный `HANDOVER.md` и находки **129**, **134**, **135** в `ANALYSIS.md`.
...
## Актуальный последний фикс: единое меню сохранений (находка 135)
...
- Контроль после этого пакета: **491/491 syntax, 78/78 sim, 16/16 roundtrip**.
