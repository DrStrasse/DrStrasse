...
if CLIENT then
    function TOOL.BuildCPanel(panel)
        ...
        panel:Help(
            ...
            "ЛЕСТНИЦА (de_train/ladderaluminium):\n" ..
            "E на стоящей — взять в руки. ЛКМ — поставить. ПКМ по машине — на борт.\n" ..
            "E на бортовой — выдвинуть. Shift+E — снять. W / прыжок — залезть.\n" ..
            "НАСОС: после /firetruck клавиша G — баки вода/пена/порошок, закачка с гидранта."
        )
    end
end
