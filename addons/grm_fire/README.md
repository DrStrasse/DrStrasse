# GRM Fire Addon 0.6.2 — vFire + оборудование GRM
...
- вода: 4000, расход **8** за импульс 0.09 с;
- пена: 500, расход **4** за импульс;
- порошок: 250, расход **2** за импульс;
- прямая подача экономит только воду и работает лишь при реально открытом связанном гидранте;
- закачка автоматически останавливается на полном баке, слив — на нуле;
- насос, его 3D2D, G-панель, HUD ствола и HUD машины читают одни NetworkVar/NW-счётчики.
