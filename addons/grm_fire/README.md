# GRM Fire Addon 0.6.1 — vFire + оборудование GRM
...
3. Идёшь к огню — по земле рисуется красная объёмная лента GRM. Узлы досеиваются каждые **26** юн., повороты сглаживаются, а уложенный извилистый путь не выпрямляется после стыковки. Макс. **2200** юн.; свободный ствол дальше не пускает.
4. **Смотка:** идёшь назад по рукаву — сегменты исчезают. E на свой гидрант/насос — свернуть целиком (и брошенный тоже).
5. На гидранте обычное **E** открывает/закрывает вентиль; **Shift+E** на открытом гидранте выдаёт рукав (2 порта).
...
10. Стационарная линия гидрант↔насос при удалении машины дальше **2296** юн. на 0.75 с автоматически сматывается, прямая подача отключается.
...
Закачка из открытого/связанного гидранта включается кнопкой в G-панели; бесконечной автозаливки нет.
