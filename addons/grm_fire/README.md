# GRM Fire Addon 0.6.0 — vFire + оборудование GRM
...
3. Идёшь к огню — по земле рисуется красная плоская лента GRM по сетевому пути узлов. Макс. **2200** юн.; свободный ствол дальше не пускает.
