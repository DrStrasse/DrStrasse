...
| `grm_fire_pump` | `cs_assault/wirepipe` / `GasPipes006a` | насос вкл, бак, взять рукав |

Все `AdminOnly` в спавне. Физика заморожена. Перм / тул расстановки — в серверном скрипте GRM.
