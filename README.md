...
| 48 | `lua/autorun/client/cl_grm_hud.lua` | HUD v10.1: HP/броня бары, деньги (`GRM.PlayerBalance`, вывод через `GRM.Format`), патроны, кастомный селектор оружия (колёсико/1-6/ЛКМ), стек уведомлений, шрифты `GRM_HUD_*`, скрытие ванильных элементов |
