...
музыкальные эмбиенты плавно меняются для дня, вечера и ночи. По умолчанию включена отдельная оригинальная тема **Noir Detective** —
медленный контрабасовый пульс, мягкое пианино, щётки и спокойное движение;
в `/weather_admin` можно вернуть профиль по времени суток. Аудио использует
