...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.5 / аддон 0.4.8 (Код 58):** шланг по земле. Машину снесли — сразу смотка всех рукавов + насос/лестница. Насос без хоста не висит. Смотка S/ALT. Выдача G / `/рукав`. Баки 4000/500/250 |
