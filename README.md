...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.7 / аддон 0.4.9 (Код 58):** G у насоса/машины — только «НАСОСНАЯ СТАНЦИЯ», инкассация не лезет. Смотришь на банкомат — инкассация. ТС снесли — рукава/насос сразу. Шланг по земле. Смотка S/ALT. `/рукав`. Баки 4000/500/250 |
