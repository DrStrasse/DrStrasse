...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.4 (Код 58):** выдача рукава с машины — G / `/рукав` / E по насосу. Смотка **на сервере**: назад по рукаву или ALT; укладка при ходе назад не кладётся. Рукав на земле — красная лента. Бортовой насос не пермится. Баки 4000/500/250 |
