...
дверные ключи `ds_key_swep`, полицейский таран `ds_battering_ram`, отмычка `ds_lockpick`,
...
| 61–62 | `lua/autorun/sh_grm_doors*.lua` | **Система Дверей v2.0.2 & Access v2.1.0:** синхронизация двойных створок, 3D2D HUD, гибкие права на ордера в `/factions` |
...
| 67 | `lua/weapons/ds_battering_ram/` | **Полицейский таран `ds_battering_ram`:** вскрытие дверей по ордеру на обыск `/warrant` или праву ForceDoor (модель `w_rocket_launcher.mdl`) |
| 68 | `lua/weapons/ds_lockpick/` | **Отмычка `ds_lockpick`:** взлом запертых дверей с прогресс-баром и звуками |
