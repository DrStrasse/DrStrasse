...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.6 / аддон 0.4.9 (Код 58):** ТС снесли — рукава/насос/лестница сразу. EntityRemoved без IsValid-барьера + свеп сирот. Шланг по земле. Смотка S/ALT. G / `/рукав`. Баки 4000/500/250 |
