...
ночь создаётся небом и мягким клиентским тоном, регулируемым в `/weather_admin`.
Также есть плавный world/skybox fog, мировые частицы дождя, гроза и HUD-часы.
Звук дождя собран из водяного фона, нерегулярных ударов, брызг и близких капель
без постоянного телевизионного шипения; под крышей он приглушается. Оригинальные
