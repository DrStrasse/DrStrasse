...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` | **Пожары v1.2.0 (Код 58):** обвязка аддона `grm_fire` + vFire. Рукав 2200, смотка назад / E на источник. Насос — голограмма `tpplugholder` без коллизии. Точки укладки невидимы. Лестница. Тул в категории GRM. Права `/fire_access`, машина `/firetruck` |
