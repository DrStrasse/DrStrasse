...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.2 (Код 58):** выдача рукава с машины — G «ВЗЯТЬ РУКАВ», `/рукав`, E по насосу; насос вешается сам при посадке. Связь с гидрантом: открыть E + подъехать или кнопка «Связать». Кабель `grm/firehose` (красный, без HL2 redcable). Баки 4000/500/250 |
