...
| 91 | `lua/entities/grm_comp_police/` | **Компьютер OrdnungPolizei:** База розыска (Wanted), база штрафов, паспортный стол, ксивы `POL-` для своей фракции |
| 92 | `lua/entities/grm_comp_military_police/` | **Компьютер Feldgendarmerie:** Военный розыск дезертиров/СОЧ, комендантские взыскания, реестр военных билетов ВС, ксивы `FELD-` |
