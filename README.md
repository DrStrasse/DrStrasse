...
| 62 | `lua/autorun/sh_01_grm_persistence_guard.lua` | **Persistence Guard v1.0.0:** до загрузки модулей снимает boot-снимок важных DATA-файлов; валидный непустой primary главнее backup, но boot/backup восстанавливает ошибочно опустевший primary. Inventory, Characters, Factions, Documents, Medical, Perm, Electronics, Phone, Factory, Logistics, RoomTap, CCTV, Alarm, Services, Diplomas и Vehicle Dealer используют зеркала и fail-closed: ошибка чтения больше не превращается в пустой autosave. Диагностика: серверная команда `grm_persistence_audit`. |
