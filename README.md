...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.4 / аддон 0.4.7 (Код 58):** шланг по земле по колышкам (не балка в воздухе). Машина уехала — досев точек от катушки, старый путь на месте. Смотка S/ALT. Выдача G / `/рукав`. Баки 4000/500/250 |
