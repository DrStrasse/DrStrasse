...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.4 / аддон 0.4.6 (Код 58):** катушка `SrcPos` на рукаве (не PVS насоса) — линия едет с машиной. `FollowHost` тащит укладку. Шаг 40, шланг ~1.9 юн. Смотка S/ALT. Выдача G / `/рукав`. Баки 4000/500/250 |
