...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.8 / аддон 0.4.9 (Код 58):** G у пожарки не орёт инкассацией (без рейса G инкассации нет). Насос/машина — только панель. ТС снесли — рукава сразу. Смотка S/ALT. `/рукав`. Баки 4000/500/250 |
