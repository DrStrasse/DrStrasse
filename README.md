...
| 61–62 | `lua/autorun/sh_grm_doors*.lua` | **Система Дверей v2.0.4 & Access v2.1.0:** синхронизация защёлки, 3D2D HUD, подавление сторонних оверлеев, меню сохраняет вкладку и прокрутку при авто-обновлении |
