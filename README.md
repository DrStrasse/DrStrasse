...
- `expression2/combine_os/` — **CMB-OS**, единый E2-чип без `@model`:
  находит уже поставленные Combine-терминалы, мониторы и кубы-датчики,
  привязывает их к слотам, меняет skin 0/1 и выдаёт проводные сигналы/стрелки.
