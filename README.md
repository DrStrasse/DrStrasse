...
| 58 | `lua/autorun/sh_grm_fire.lua` + `sh_grm_fire_access.lua` + `sh_grm_fire_truck.lua` + `sh_grm_fire_pump_ui.lua` | **Пожары v1.3.4 / аддон 0.4.5 (Код 58):** рукав тянется за машиной (`FollowHost`). Смотка на сервере: проекция / S / ALT. Шаг укладки 52, тонкий шланг (~2.4 юн.). Выдача G / `/рукав`. Бортовой насос не пермится. Баки 4000/500/250 |
