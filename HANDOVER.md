...
- Пожары v1.3.6 / аддон 0.4.9: ТС удалили — рукава/насос сразу.
  EntityRemoved не режется IsValid; `ClearOrphanHoses` на следующем тике.
  Наземный насос из тула не трогаем. Нужны оба zip.
