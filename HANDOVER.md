...
- Пожары v1.3.8 / инкассация 2.2.2: G без рейса `/incass` инкассацию
  не трогает и не орёт «нет рейса». У насоса/своей пожарки — только панель.
  Нужен `grm_single_addon.zip` + рестарт. Fire-аддон для этого фикса не нужен.
