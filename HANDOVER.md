...
- Пожары v1.3.5 / аддон 0.4.8: шланг по земле. ТС удалили — `DropTruckGear`
  сразу сматывает рукава и снимает насос/лестницу. Насос без хоста
  сам снимается, рукав без источника — Rewind. Нужны оба zip.
