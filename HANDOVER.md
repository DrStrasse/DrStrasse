...
- Пожары v1.3.2: выдача с машины — G «ВЗЯТЬ РУКАВ», `/рукав`, E по насосу.
  Насос вешается сам при посадке в listed ТС. Гидрант: открыть E + 380 юн.
  или «Связать». Кабель `grm/firehose` (не redcable). Нужны оба zip.
