...
- Пожары v1.3.4 / аддон 0.4.5: рукав тянется за машиной (`FollowHost`).
  Тонкий шланг, шаг 52. Смотка серверная (проекция / S / ALT).
  Выдача: G / `/рукав`. Бортовой насос не пермится.
