...
- Пожары v1.3.4 / аддон 0.4.6: катушка `SrcPos` на рукаве — линия едет с машиной
  даже если насос вне PVS. FollowHost тащит укладку. Шаг 40, тонкий шланг.
  Смотка S/ALT. Выдача G / `/рукав`. Нужны оба zip.
