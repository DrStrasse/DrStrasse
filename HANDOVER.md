...
- Пожары v1.3.4 / аддон 0.4.7: шланг лежит по земле по колышкам, не балка
  насос→рука. Машина едет — `PayoutFromSource` досевает точки, старый путь
  не натягивается. Смотка S/ALT. Выдача G / `/рукав`. Нужны оба zip.
