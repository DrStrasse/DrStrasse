...
- Пожары v1.3.1: рукав с машины — кнопка G «ВЗЯТЬ РУКАВ» или E по ТС/насосу
  (насос больше не NotSolid). Связь с гидрантом: открыть E + подъехать 380
  или кнопка «Связать» (прокладка до 2200). Кабель красный, не альфа-0.
